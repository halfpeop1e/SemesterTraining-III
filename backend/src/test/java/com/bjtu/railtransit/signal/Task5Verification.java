 ...
 * - 数值算例（§2.5）经 REST 入口 → ApiResponse{success:true, message:"",
 * data.T2.endOfAuthorityM=750}
 * - Jackson 序列化后的 JSON 形态符合 verification.md §3
 * 契约（success/data/endOfAuthorityM/PRECEDING_TRAIN）
...
public class Task5Verification {
    ...
    static LineProfile flatLine(double total) {
    ...
    static void checkMaEndpoint() throws Exception {
        ...
        ApiResponse<java.util.Map<String, MovingAuthority>> resp = (ApiResponse<java.util.Map<String, MovingAuthority>>) raw;
    ...
    static void checkFailSafeViaApi() {
        ...
        ApiResponse<java.util.Map<String, MovingAuthority>> resp = (ApiResponse<java.util.Map<String, MovingAuthority>>) ctrl
                .ma(req);
