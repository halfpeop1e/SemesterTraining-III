        ...
        <Col xs={12} sm={6}>
          ...
          >
            <Statistic
              ...
              styles={{
                content: {
                  color: (status?.alertCount ?? 0) > 0 ? "#ef4444" : "#22c55e",
                  fontSize: 28,
                  fontWeight: 700,
                  fontFamily: "'JetBrains Mono', monospace",
                },
          ...
          >
            ...
            <div className="flex items-center gap-3">
              <div
                ...
                style={{
                  background: `${HEALTH_COLOR[status?.health ?? "HEALTHY"]}18`,
                  color: HEALTH_COLOR[status?.health ?? "HEALTHY"],
                }}
              >
                  ...
                  <List.Item className="px-5 py-3 border-b-slate-800/40!">
                    <div className="w-full">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <Tag className="text-[10px] leading-4 px-1">
