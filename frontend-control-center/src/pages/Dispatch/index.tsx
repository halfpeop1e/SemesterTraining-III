...
/* ═══════════════════════════════════════════════
   ...
   ═══════════════════════════════════════════════ */
.dispatcher-workstation{position:fixed;top:76px;right:16px;z-index:45;width:min(374px,calc(100vw - 32px));max-height:calc(100vh - 92px);overflow:auto;background:rgba(11,24,42,.82);border:1px solid rgba(53,198,255,.28);border-radius:8px;padding:12px;color:var(--color-text);box-shadow:0 12px 38px rgba(0,0,0,.38),inset 0 1px 0 rgba(255,255,255,.07);backdrop-filter:blur(18px);-webkit-backdrop-filter:blur(18px);font-size:12px;transition:width var(--transition-base),border-color var(--transition-base),box-shadow var(--transition-base)}
.dispatcher-workstation:hover{border-color:rgba(53,198,255,.52);box-shadow:0 16px 46px rgba(0,0,0,.46),0 0 24px rgba(0,168,232,.1)}.dispatcher-workstation.is-collapsed{right:-14px;width:30px;overflow:hidden;padding:4px}.dispatcher-workstation.is-collapsed header{justify-content:center;margin:0}.dispatcher-workstation.is-collapsed header>div{display:none}.dispatcher-workstation.is-collapsed .dispatcher-workstation__collapse{width:22px;height:28px}
.dispatcher-workstation header{display:flex;align-items:center;justify-content:space-between;gap:10px;margin-bottom:10px}.dispatcher-workstation header>div{display:flex;align-items:baseline;gap:8px;min-width:0}.dispatcher-workstation header strong{font-size:15px;color:#ecf8ff;white-space:nowrap}.dispatcher-workstation .online,.dispatcher-workstation .paused{font-size:11px;font-weight:700;white-space:nowrap}.dispatcher-workstation .online{color:#37e3bd}.dispatcher-workstation .paused{color:var(--color-warning)}
.dispatcher-workstation__collapse{width:26px;height:26px;display:grid;place-items:center;padding:0!important;background:rgba(68,154,200,.15)!important;border:1px solid rgba(91,202,255,.28)!important;color:#bfeeff!important;font-size:20px;line-height:1}.dispatcher-workstation__collapse:hover{background:rgba(0,168,232,.3)!important}
.workstation-metrics{display:grid;grid-template-columns:1fr 1fr;gap:7px;margin-bottom:11px}.workstation-metrics span{display:flex;align-items:center;gap:5px;min-height:34px;background:rgba(26,50,76,.66);border:1px solid rgba(116,177,219,.14);padding:6px 7px;border-radius:5px;color:#b9cde1}.workstation-metrics b{color:#f4fbff;font-size:14px}.signal-ok,.signal-wait{width:7px;height:7px;border-radius:50%;display:inline-block;background:#35dfba;box-shadow:0 0 10px rgba(53,223,186,.8)}.signal-wait{background:#f7b84b;box-shadow:0 0 10px rgba(247,184,75,.6)}
.dispatcher-workstation button{background:var(--color-accent);color:white;border:0;border-radius:4px;padding:6px var(--space-sm);cursor:pointer;transition:all var(--transition-fast)}
...
.onboard-monitor-title{margin:8px 0 6px;color:#70dfff;font-weight:700;font-size:12px;letter-spacing:.5px}.onboard-monitor-empty{padding:10px;margin-bottom:var(--space-sm);color:var(--color-text-tertiary);background:rgba(26,50,76,.4);border:1px dashed rgba(116,177,219,.3);border-radius:5px}
.onboard-monitor-card{display:grid;gap:7px;margin-bottom:8px;padding:10px;background:linear-gradient(115deg,rgba(24,56,83,.82),rgba(11,30,51,.76));border:1px solid rgba(97,191,239,.14);border-left:3px solid var(--color-text-tertiary);border-radius:5px;color:var(--color-text);transition:border-color var(--transition-fast),background var(--transition-fast)}
.onboard-monitor-card:hover{border-color:rgba(77,207,255,.42);background:linear-gradient(115deg,rgba(28,68,99,.86),rgba(12,36,60,.8))}
.onboard-monitor-card.is-online{border-left-color:var(--color-success)}.onboard-monitor-card.is-offline{opacity:.62}
.onboard-monitor-head{display:flex;align-items:center;gap:7px}.onboard-monitor-head b{font-size:16px;color:#fff;letter-spacing:.5px}.onboard-monitor-head span{color:var(--color-success);font-size:11px;font-weight:700}.onboard-monitor-card.is-offline .onboard-monitor-head span{color:var(--color-danger)}.onboard-monitor-head small{margin-left:auto;color:#9bb2c8;font-size:10px}
.onboard-monitor-route{color:#d9ecfa;font-size:12px}.onboard-monitor-route em{float:right;font-style:normal;color:#64d7fa;font-size:10px}.onboard-monitor-readings{display:grid;grid-template-columns:1fr 1fr 1.15fr;gap:6px}.onboard-monitor-readings span{min-width:0;display:flex;flex-direction:column;color:#eef8ff;font-family:var(--font-mono);font-size:12px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.onboard-monitor-readings small{color:#89a8c0;font-family:inherit;font-size:10px;margin-bottom:2px}.onboard-monitor-meta{color:#7896b0;font-size:10px;border-top:1px solid rgba(122,183,224,.12);padding-top:6px}
.onboard-monitor-conflict{color:var(--color-warning);font-weight:700}
.onboard-depart-actions{display:flex;gap:6px;margin-top:2px}.onboard-depart-actions button{flex:1;background:#009cca;transition:all var(--transition-fast)}.onboard-depart-actions button:hover{opacity:0.9}.onboard-depart-actions button+button{background:rgba(70,119,154,.55)}
...
@media(max-width:760px){.dispatcher-workstation{top:60px;right:8px;width:min(350px,calc(100vw - 16px));max-height:calc(100vh - 68px)}}
